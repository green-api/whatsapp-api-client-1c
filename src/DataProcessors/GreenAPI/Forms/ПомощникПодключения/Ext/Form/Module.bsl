...
Процедура КомандаГотово(Команда)
	...
	ОповеститьОВыборе(Новый Структура("IdInstance, ApiToken", Объект.IdInstance, Объект.ApiToken));
...
Процедура ПодтвердитьЗакрытиеПроизвольнойФормыСейчас() Экспорт
	...
	ПодтвердитьЗакрытиеПроизвольнойФормы();
...
Процедура ПодтвердитьЗакрытиеПроизвольнойФормы() Экспорт
	...
	Оповещение = Новый ОписаниеОповещения("ПодтвердитьЗакрытиеПроизвольнойФормыЗавершение", ЭтотОбъект, ПараметрыФормы);
...
Процедура ЗарегистрироватьсяВGreenAPI(Команда)
	ЗапуститьПриложение("https://cabinet.green-api.com/");
КонецПроцедуры
