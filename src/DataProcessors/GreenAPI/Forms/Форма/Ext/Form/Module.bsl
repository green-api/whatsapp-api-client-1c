...
//
// Параметры:
//  НомерУведомления - Число - Идентификатор доставки для удаления входящего уведомления, 
//   полученный методом ПолучитьУведомление()
// 
// Возвращаемое значение:
//  ЧтениеJSON  - Ответ сервера
//
...
//  ЧтениеJSON  - Ответ сервера
//
Функция УстановитьАватарГруппы(ИдГруппы, ПутьКФайлу) Экспорт
	...
	Возврат ОтправитьФайлPOSTЗапрос(ХостПоУмолчанию(), URLМетодаСервиса(Инстанс, Токен, "setGroupPicture"), Заголовки, ДанныеТела);
