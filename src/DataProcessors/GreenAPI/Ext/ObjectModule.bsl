...
ПРоцедура ПолучитьСообщение(Инстанс, Токен) Экспорт
	...
	Ответ = ПолучитьУведомление(Инстанс, Токен);
...
Функция СканироватьQRКод(Инстанс, Токен) Экспорт
	
	Возврат ОтправитьGETЗапрос(ХостПоУмолчанию(), URLМетодаСервиса(Инстанс, Токен, "qr"), Истина);
	
КонецФункции

Функция ПолучитьСтатусСервиса(Инстанс, Токен) Экспорт
...
Функция ПолучитьУведомление(Инстанс, Токен) Экспорт
...
Функция ОтправитьСообщениеТекст(Инстанс, Токен, Телефон, Сообщение) Экспорт
...
Функция ОтправитьСообщениеWhatsApp(Инстанс, Токен, Телефон, Сообщение) Экспорт
...
Функция УдалитьСообщение(Инстанс, Токен, ТегСообщения) Экспорт
...
Функция ПолучитьНастройкиСервиса(Инстанс, Токен) Экспорт
...
Функция УстановитьНастройкуСервиса(Инстанс, Токен, Ключ, Значение) Экспорт
...
Функция РазлогинитьАккаунт(Инстанс, Токен) Экспорт
